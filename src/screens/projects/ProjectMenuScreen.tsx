...
type NavigationProp = StackNavigationProp<RootStackParamList, "ProjectMenuScreen">;

const ProjectMenuScreen: React.FC = () => {
  ...
  const goToViewProjects = () => navigation.navigate("ViewProjects");
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <View style={styles.row}>
          <TouchableOpacity style={styles.squareButton} onPress={goToCreateProject}>
            <Text style={styles.buttonText}>Crear Proyecto</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.squareButton} onPress={goToViewProjects}>
