...
import { generateFactoresRiesgoExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "FactoresRiesgoReport">;

const FactoresRiesgoReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Factores de Riesgo</Text>
        <TouchableOpacity style={styles.button} onPress={generateFactoresRiesgoExcel}>
...
export default FactoresRiesgoReport;
