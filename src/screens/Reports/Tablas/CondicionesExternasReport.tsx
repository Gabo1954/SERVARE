...
import { generateCondicionesExternasExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "CondicionesExternasReport">;

const CondicionesExternasReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Condiciones Externas</Text>
        <TouchableOpacity style={styles.button} onPress={generateCondicionesExternasExcel}>
...
export default CondicionesExternasReport;
