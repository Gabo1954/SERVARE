...
import { generateIncidenciaExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "IncidenciaReport">;
const IncidenciaReport: React.FC = () => {
    ...
    return (
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Incidencia</Text>
        <TouchableOpacity style={styles.button} onPress={generateIncidenciaExcel}>
...
export default IncidenciaReport;
