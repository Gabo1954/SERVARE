...
import { generateExtensionExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "ExtensionReport">;

const ExtensionReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Extensión</Text>
        <TouchableOpacity style={styles.button} onPress={generateExtensionExcel}>
