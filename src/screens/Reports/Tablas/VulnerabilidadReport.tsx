...
import { generateVulnerabilidadExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "VulnerabilidadReport">;

const VulnerabilidadReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Vulnerabilidad Mat/Alt</Text>
        <TouchableOpacity style={styles.button} onPress={generateVulnerabilidadExcel}>
...
export default VulnerabilidadReport;
