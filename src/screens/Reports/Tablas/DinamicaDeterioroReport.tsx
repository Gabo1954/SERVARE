// DinamicaDeterioroReport.tsx
import React, { useState } from 'react';
import { View, Text, TouchableOpacity, StyleSheet, Image } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { useNavigation } from '@react-navigation/native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { generateDinamicaDeterioroExcel } from '../../../components/reports/generateExcelReport';
import { StackNavigationProp } from "@react-navigation/stack";
import { RootStackParamList } from "../../../navigation/AppNavigator";

type NavigationProp = StackNavigationProp<RootStackParamList, "DinamicaDeterioroReport">;

const DinamicaDeterioroReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Dinámica del Deterioro</Text>
        <TouchableOpacity style={styles.button} onPress={generateDinamicaDeterioroExcel}>
...
export default DinamicaDeterioroReport;
