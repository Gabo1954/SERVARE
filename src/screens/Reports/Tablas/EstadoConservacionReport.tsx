...
import { generateEstadoConservacionExcel } from '../../../components/reports/generateExcelReport';

type NavigationProp = StackNavigationProp<RootStackParamList, "EstadoConservacionReport">;

const EstadoConservacionReport: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Estado de Conservación</Text>
        <TouchableOpacity style={styles.button} onPress={generateEstadoConservacionExcel}>
...
export default EstadoConservacionReport;
