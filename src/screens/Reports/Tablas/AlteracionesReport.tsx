// AlteracionesReport.tsx
import React, { useState } from 'react';
import { View, Text, TouchableOpacity, StyleSheet, Image } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { useNavigation } from '@react-navigation/native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { generateAlteracionesExcel } from '../../../components/reports/generateExcelReport';
import { StackNavigationProp } from "@react-navigation/stack";
import { RootStackParamList } from "../../../navigation/AppNavigator";

type NavigationProp = StackNavigationProp<RootStackParamList, "AlteracionesReport">;

const AlteracionesReport: React.FC = () => {
    ...
    return (
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Alteraciones</Text>
        <TouchableOpacity style={styles.button} onPress={generateAlteracionesExcel}>
...
export default AlteracionesReport;
