...
import { generateHistorialIntervencionesExcel } from '../../../components/reports/generateExcelReport';



type NavigationProp = StackNavigationProp<RootStackParamList, "HistorialIntervencionesReport">;

const HistorialIntervencionesReport: React.FC = () => {
    ...
    return (
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Tabla de Historial de Intervenciones</Text>
        <TouchableOpacity style={styles.button} onPress={generateHistorialIntervencionesExcel}>
...
export default HistorialIntervencionesReport;
